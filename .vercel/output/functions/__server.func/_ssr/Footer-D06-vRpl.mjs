...
import { D as Dialog, a as DialogTrigger, b as DialogContent } from "./dialog-CoSbALlQ.mjs";
import { B as Button } from "./button-l9t-pzF9.mjs";
import { u as useAuth, l as logoUrl, I as Input, c as cn, s as supabase } from "./router-Yefiub0V.mjs";
...
import { a as Calculator, b as LogOut, H as Handshake, c as ChevronDown, X, M as Menu, d as House, S as Star, e as MessageSquare, P as Phone, f as Mail, g as MapPin, F as Facebook, I as Instagram, h as Linkedin, i as LogIn, L as LoaderCircle, j as Send, k as MessageCircle } from "../_libs/lucide-react.mjs";
...
const cleanAmount = (value) => value.replace(/[₹,\s]/g, "").replace(/[^\d]/g, "");
function LeadForm({
  productType,
  productName,
  ...
  const inputClass = "h-11 w-full rounded-xl border border-sky-200 bg-white px-4 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-sky-400 focus:ring-4 focus:ring-sky-100";
  const selectClass = "h-11 w-full cursor-pointer rounded-xl border border-sky-200 bg-white px-4 text-sm text-slate-900 shadow-sm outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full overflow-hidden rounded-3xl border border-sky-100 bg-white shadow-[0_18px_50px_rgba(14,165,233,0.18)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-sky-100 via-blue-100 to-cyan-100 px-5 py-5 text-slate-900 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-[#17357e] sm:text-2xl", children: productName ? `${productName} Enquiry` : "Apply Now" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-slate-600", children: "Fill your details and our expert will contact you shortly." })
    ] }),
      ...
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[92px_1fr] gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  ...
                  "aria-label": "Title",
                  children: NAME_TITLES.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t, children: t }, t))
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-11 items-center rounded-l-xl border border-r-0 border-sky-200 bg-sky-50 px-3 text-sm font-medium text-slate-600", children: "+91" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  inputMode: "numeric",
...
function Header() {
  ...
  const [barHidden, setBarHidden] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    showBottomNav && !barHidden && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-6 left-1/2 z-[9999] flex w-[94vw] max-w-[620px] -translate-x-1/2 justify-center sm:bottom-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex w-full items-center justify-between gap-2 rounded-full border border-white/20 bg-white/95 px-3 py-3 shadow-2xl backdrop-blur-xl sm:gap-6 sm:px-8 sm:py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    showBottomNav && barHidden && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-3.5 w-3.5" }),
          " Menu"
        ]
      }
    )
...
function WhatsAppFab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-28 right-4 z-50 flex flex-col items-end gap-3 sm:bottom-5 sm:right-5", children: [
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { id: "contact", className: "bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        id: "faqs",
        className: "border-t border-border/40 px-4 py-12 sm:px-6 sm:py-16",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/40 bg-white pb-24 lg:pb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 py-10 lg:grid lg:grid-cols-[1.4fr_0.8fr_0.9fr_0.9fr_1.4fr_0.8fr] lg:gap-8 lg:py-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-3 lg:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => toggleSection("products"),
              className: "flex w-full items-center justify-between px-4 py-4 text-left text-base font-bold text-foreground",
              children: [
                "Products",
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ChevronDown,
                  {
                    className: `h-5 w-5 transition ${openSection === "products" ? "rotate-180" : ""}`
                  }
                )
              ]
            }
          ),
          openSection === "products" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground", children: [
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ChevronDown,
                  {
                    className: `h-5 w-5 transition ${openSection === "tools" ? "rotate-180" : ""}`
                  }
                )
              ]
            }
          ),
          openSection === "tools" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/",
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ChevronDown,
                  {
                    className: `h-5 w-5 transition ${openSection === "company" ? "rotate-180" : ""}`
                  }
                )
              ]
            }
          ),
          openSection === "company" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground", children: [
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ChevronDown,
                  {
                    className: `h-5 w-5 transition ${openSection === "contact" ? "rotate-180" : ""}`
                  }
                )
              ]
            }
          ),
          openSection === "contact" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "leading-6", children: "2nd Floor, Shrinath Tower, Opposite C3 Hospital, Behind C21 Mall, Vijay Nagar, Indore, MP 452010" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-200 bg-white", children: [
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ChevronDown,
                  {
                    className: `h-5 w-5 transition ${openSection === "follow" ? "rotate-180" : ""}`
                  }
                )
              ]
            }
          ),
          openSection === "follow" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: "https://www.facebook.com/profile.php?id=61591125326433",
                target: "_blank",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/60 bg-white pb-28 pt-5 lg:pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex flex-col items-center justify-between gap-3 px-6 text-center text-xs text-muted-foreground sm:flex-row sm:text-left", children: [
