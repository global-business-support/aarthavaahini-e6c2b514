...
import { s as supabase, C as Card, c as cn, I as Input } from "./router-Yefiub0V.mjs";
...
import { u as SquareCheckBig, ay as Plus, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
function NewTaskForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[110px_1fr] gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Title *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: form.salutation, onChange: (event) => setForm((prev) => ({
          ...prev,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Miss", children: "Miss" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Full Name *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { required: true, value: form.full_name, onChange: (event) => {
          const v = event.target.value.replace(/[^A-Za-z.\s]/g, "").replace(/\s+/g, " ").replace(/\b\w/g, (c) => c.toUpperCase());
          setForm((prev) => ({
            ...prev,
            full_name: v
          }));
        }, className: "mt-1 border-sky-200 focus-visible:ring-sky-400", placeholder: "Rahul Sharma" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "datetime-local", min: nowLocal(), value: form.due_date, onChange: (event) => setForm((prev) => ({
          ...prev,
