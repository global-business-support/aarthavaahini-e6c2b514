...
import { u as useAuth, s as supabase, c as cn, C as Card, I as Input } from "./router-Yefiub0V.mjs";
...
import { W as Sparkles, ay as Plus, G as Search, L as LoaderCircle, C as CircleCheck, p as CircleX, as as StickyNote, k as MessageCircle } from "../_libs/lucide-react.mjs";
...
function LeadsPage() {
  ...
  const filtered = leads.filter((l) => {
    ...
    const matchesText = !term || (l.lead_name ?? l.full_name ?? "").toLowerCase().includes(term) || l.phone.includes(term);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-w-[220px] flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search name, phone…", value: filter, onChange: (e) => setFilter(e.target.value), className: "pl-9" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: bankFilter, onValueChange: setBankFilter, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "max-h-72 bg-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "overflow-hidden", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-48 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin text-muted-foreground" }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-10 text-center text-sm text-slate-500", children: "No leads match your filters." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: filtered.map((l) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm", children: formatAmount(l.loan_amount) }),
...
function NewLeadForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "grid grid-cols-1 gap-3 sm:grid-cols-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Loan Amount (₹)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", inputMode: "numeric", className: "border-emerald-200 focus-visible:ring-emerald-400", placeholder: "500000", value: f.loan_amount, onChange: (e) => setF((prev) => ({
      ...prev,
...
function ApproveLeadDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!lead, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-h-[90vh] max-w-2xl overflow-y-auto bg-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", inputMode: "numeric", className: "mt-1", value: f.requested_amount, onChange: (e) => setF({
            ...f,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", inputMode: "numeric", className: "mt-1", value: f.sanction_amount, onChange: (e) => setF({
            ...f,
...
function RejectLeadDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!lead, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md bg-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Rejected Reason *" }),
