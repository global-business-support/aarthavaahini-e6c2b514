...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-MXjOXbbH.mjs");
...
const manifest = {
  "47e81299f8812b394f201eb7829313753c8d3b708795d858ea7949687cef4aec": {
    functionName: "resetEmployeePassword_createServerFn_handler",
    importer: () => import("./employees.functions-DVFe86ub.mjs")
  },
  "6994abae10ce20c1c7ee0082e1fceeab981ef11dfcbeb83f7f67977b158c28c0": {
    functionName: "deleteEmployee_createServerFn_handler",
    importer: () => import("./employees.functions-DVFe86ub.mjs")
  },
  "74a58c73313e14de3edc4f89c650c0ce6c794292f220878d6039341c993f975f": {
    functionName: "listEmployees_createServerFn_handler",
    importer: () => import("./employees.functions-DVFe86ub.mjs")
  },
  "751e6efe2b428466158e55a04cc4a268942ac15417fd3382f4d6205650aa649e": {
    functionName: "sendWhatsApp_createServerFn_handler",
    importer: () => import("./twilio.functions-BusFqMI0.mjs")
  },
  "8f1ebf734379d5d119683110ab75ae99281d57ed301b9c7b93c3e41d5d1f09d6": {
    functionName: "createEmployee_createServerFn_handler",
    importer: () => import("./employees.functions-DVFe86ub.mjs")
  },
  "e75a0a04b046cc3ba29f9856b6f8f9008290f07b94382841dadd044b7a58d9af": {
    functionName: "twilioConfig_createServerFn_handler",
    importer: () => import("./twilio.functions-BusFqMI0.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-fcTUeZV3.mjs").then((n) => n.r),
    import("./start-DSjlA6Oo.mjs"),
