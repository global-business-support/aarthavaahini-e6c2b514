...
const $$splitComponentImporter$F = () => import("./partner-signup-CWELFtBZ.mjs");
...
const $$splitComponentImporter$E = () => import("./partner-1uZzjyFL.mjs");
const Route$E = createFileRoute("/partner")({
  component: lazyRouteComponent($$splitComponentImporter$E, "component")
});
const $$splitComponentImporter$D = () => import("./mutual-funds-DW66hAKa.mjs");
...
const $$splitComponentImporter$C = () => import("./login-D9rw65WV.mjs");
...
const $$splitComponentImporter$B = () => import("./loans-Ckw_63UA.mjs");
...
const $$splitComponentImporter$A = () => import("./insurance-BfIS2GBu.mjs");
...
const $$splitComponentImporter$z = () => import("./directors-C8eByPrW.mjs");
const Route$z = createFileRoute("/directors")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./dashboard-DWQ8VR33.mjs");
const Route$y = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$y, "component")
});
const $$splitComponentImporter$x = () => import("./crm-Dd4-BJFw.mjs");
...
const $$splitComponentImporter$w = () => import("./contact-CblbTQ2p.mjs");
...
const $$splitComponentImporter$v = () => import("./cibil-I0-G9F1l.mjs");
...
const $$splitComponentImporter$u = () => import("./blogs-CymGe-lR.mjs");
const Route$u = createFileRoute("/blogs")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./admin-Dla8zi8V.mjs");
...
const $$splitComponentImporter$s = () => import("./about-D_h6qD_E.mjs");
...
const $$splitComponentImporter$r = () => import("./index-DxuMA-1g.mjs");
const Route$r = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./partner.index-DoYBX1Ij.mjs");
const Route$q = createFileRoute("/partner/")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("./crm.index-CYsBspCQ.mjs");
const Route$p = createFileRoute("/crm/")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./partner.profile-C2HFKFWN.mjs");
const Route$o = createFileRoute("/partner/profile")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./partner.leads-LuRJt2sM.mjs");
const Route$n = createFileRoute("/partner/leads")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./crm.whatsapp-DSLdHUpI.mjs");
...
const $$splitComponentImporter$l = () => import("./crm.tasks-B81c__nT.mjs");
const Route$l = createFileRoute("/crm/tasks")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./crm.settings-BqdfUtcb.mjs");
const Route$k = createFileRoute("/crm/settings")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./crm.schedule-DsZTjVxB.mjs");
...
const $$splitComponentImporter$i = () => import("./crm.reports-DFppcI1u.mjs");
const Route$i = createFileRoute("/crm/reports")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./crm.rejected-yGs9FWbG.mjs");
const Route$h = createFileRoute("/crm/rejected")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./crm.partners-Bd301Ub9.mjs");
const Route$g = createFileRoute("/crm/partners")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./crm.mutual-funds-Bg52ECUF.mjs");
const Route$f = createFileRoute("/crm/mutual-funds")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./crm.login-gfWr_JiJ.mjs");
...
const $$splitComponentImporter$d = () => import("./crm.loans-pt9wZfZo.mjs");
const Route$d = createFileRoute("/crm/loans")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./crm.leads-y_KZWfXa.mjs");
const Route$c = createFileRoute("/crm/leads")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./crm.insurance-nr0t838c.mjs");
const Route$b = createFileRoute("/crm/insurance")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./crm.employees-DOVChmjP.mjs");
const Route$a = createFileRoute("/crm/employees")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./crm.documents-DtlyXHdJ.mjs");
const Route$9 = createFileRoute("/crm/documents")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./crm.customers-fxvAAXA6.mjs");
const Route$8 = createFileRoute("/crm/customers")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./crm.cms-DWpkXBG9.mjs");
const Route$7 = createFileRoute("/crm/cms")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./crm.banks-Czdx-yC9.mjs");
const Route$6 = createFileRoute("/crm/banks")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./crm.activity-sseJoRab.mjs");
const Route$5 = createFileRoute("/crm/activity")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./sip-guide-BUvFlmuB.mjs");
const Route$4 = createFileRoute("/blogs/sip-guide")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./home-loan-guide-CU7RG3A6.mjs");
const Route$3 = createFileRoute("/blogs/home-loan-guide")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./cibil-score-Dm3RCbUy.mjs");
const Route$2 = createFileRoute("/blogs/cibil-score")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.whatsapp-CWrrd75K.mjs");
...
const $$splitComponentImporter = () => import("./admin.employees-DSlbQPU-.mjs");
