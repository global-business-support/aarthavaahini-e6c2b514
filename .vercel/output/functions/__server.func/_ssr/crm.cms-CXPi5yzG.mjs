...
import { s as supabase, C as Card, I as Input, S as Switch } from "./router-Yefiub0V.mjs";
...
import { ay as Plus, aF as Pencil, aw as Trash2 } from "../_libs/lucide-react.mjs";
...
function CmsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Manage hero banners, homepage product cards and testimonials. Changes show up immediately on the public site." })
    ] }),
