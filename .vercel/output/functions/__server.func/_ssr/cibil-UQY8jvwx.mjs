...
import { H as Header, N as NAME_TITLES, s as sanitizeName, a as sanitizePan, b as sanitizePhone10, F as Footer, v as validateLead } from "./Footer-D06-vRpl.mjs";
...
import { V as Gauge, L as LoaderCircle, C as CircleCheck } from "../_libs/lucide-react.mjs";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: check, className: "mt-6 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: form.title, onChange: (e) => setForm({
                ...form,
                title: e.target.value
              }), className: "h-11 w-24 rounded-md border border-input bg-background px-2 text-sm", "aria-label": "Title", children: NAME_TITLES.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t, children: t }, t)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "h-11", required: true, value: form.full_name, onChange: (e) => setForm({
                ...form,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1.5 h-11 uppercase", placeholder: "ABCDE1234F", maxLength: 10, value: form.pan, onChange: (e) => setForm({
                ...form,
                pan: sanitizePan(e.target.value)
              }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Mobile" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-11 items-center rounded-l-md border border-r-0 border-input bg-muted px-3 text-sm", children: "+91" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "h-11 rounded-l-none", required: true, inputMode: "numeric", maxLength: 10, placeholder: "9xxxxxxxxx", value: form.phone, onChange: (e) => setForm({
                  ...form,
