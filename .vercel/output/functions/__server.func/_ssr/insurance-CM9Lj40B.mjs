...
import { H as Header, i as insurance, F as Footer } from "./Footer-D06-vRpl.mjs";
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background relative", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedBackground, { variant: "insurance" }),
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative isolate overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProductPage, { title: "Insurance", subtitle: "Your family's protection comes first — choose from the best plans offered by top insurers.", items: insurance, productType: "insurance", accentClass: "text-[#183c93]" })
  ] }),
