...
import { aA as TrendingUp, ap as Search, a4 as LoaderCircle, aj as Phone, a8 as Mail } from "../_libs/lucide-react.mjs";
...
function MFPage() {
  ...
  const load = async () => {
    ...
    const {
      data
    } = await supabase.from("leads").select("id, full_name, phone, email, city, product_name, amount, status, lead_source, created_at").eq("product_type", "mutual_fund").order("created_at", {
      ascending: false
    });
    setRows(data ?? []);
    setLoading(false);
  ...
  reactExports.useEffect(() => {
    load();
    const ch = supabase.channel("mf-leads").on("postgres_changes", {
      event: "*",
      schema: "public",
      table: "leads"
    }, () => load()).subscribe();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 p-5 text-white shadow-lg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-2 text-2xl font-bold md:text-3xl", children: "Mutual Fund Leads" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-w-[220px] flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search name, phone, email, fund…", value: q, onChange: (e) => setQ(e.target.value), className: "pl-9" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "overflow-hidden", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-40 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin text-muted-foreground" }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-10 text-center text-sm text-slate-500", children: "No mutual fund leads yet. New enquiries from the website will appear here automatically." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Fund" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "SIP / Amount" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: filtered.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.product_name ?? "—" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: r.amount ? `₹${Number(r.amount).toLocaleString("en-IN")}` : "—" }),
