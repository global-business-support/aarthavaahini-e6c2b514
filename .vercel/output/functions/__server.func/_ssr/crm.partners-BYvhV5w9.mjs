...
import { H as Handshake, G as Search, L as LoaderCircle, P as Phone, f as Mail, g as MapPin, aC as Eye, C as CircleCheck, p as CircleX } from "../_libs/lucide-react.mjs";
...
const getPartnerField = (message, label) => {
  if (!message) return "";
  const line = message.split("\n").find((item) => item.trim().toLowerCase().startsWith(`${label.toLowerCase()}:`));
  return line ? line.split(":").slice(1).join(":").trim() : "";
};
const getPartnerNotes = (message) => {
  if (!message) return "—";
  const notes = getPartnerField(message, "Notes");
  if (notes) return notes;
  const cleaned = message.replace(/Partner Application/i, "").replace(/Organisation:.*\n?/i, "").replace(/Category:.*\n?/i, "").replace(/Experience:.*\n?/i, "").replace(/Notes:/i, "").trim();
  return cleaned || "—";
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!view, onOpenChange: (o) => !o && setView(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg bg-white", children: [
      ...
      view && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Organisation", value: getPartnerField(view.message, "Organisation") || "—" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Experience", value: getPartnerField(view.message, "Experience") || "—" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 rounded-lg bg-slate-50 p-3 text-xs leading-relaxed text-slate-700", children: getPartnerNotes(view.message) })
        ] })
      ] })
    ] }) })
  ] });
...
function Row({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-4 border-b border-slate-100 pb-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase text-slate-500", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right text-slate-800", children: value ?? "—" })
  ] });
}
export {
