      ...
      <main className="container mx-auto px-6 py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-600">
            Join Aarthvaahini Financial Services and grow with our loan,
            insurance, mutual fund, and financial product distribution network.
          </p>

          <div className="mt-10 rounded-3xl bg-gradient-to-r from-[#17357e] to-blue-600 p-8 text-left text-white shadow-xl">
            <h2 className="text-2xl font-bold">Partner Benefits</h2>

            <ul className="mt-5 space-y-3 leading-7">
              <li>• Access to multiple financial products</li>
              <li>• Support for loans, insurance, and investments</li>
              <li>• Professional guidance and backend support</li>
              <li>• Growth opportunity with a trusted financial services brand</li>
            </ul>

            <Link to="/contact">
              <Button className="mt-7 bg-white text-[#17357e] hover:bg-blue-50">
