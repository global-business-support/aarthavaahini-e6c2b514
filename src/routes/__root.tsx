...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aarthvaahini — Srijan se Samriddhi tak" },
      { property: "og:description", content: "Premium financial services: Loans, Insurance, Mutual Funds, CIBIL checker and Advisor Admin Panel." },
