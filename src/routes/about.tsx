...
// //   address:
// //     "2nd Floor, Shrinath Tower, Opposite C3 Hospital, Behind C21 Mall, Vijay Nagar, Indore, MP 452010",
...
// //             At{" "}
// //             <strong>Aarthvaahini Financial Services Private Limited</strong>, we
...
// //             regulatory frameworks. Navigating it requires more than just
// //             standard products — it demands an architect.
// //           </p>

// //           <p className="mt-4 text-base leading-relaxed text-muted-foreground">
// //             We are a full-service financial advisory and solutions firm
// //             dedicated to bridging the gap between your current financial reality
// //             and your ultimate life or business goals. Whether you are an
// //             individual safeguarding your family&apos;s future or a corporate
// //             entity scaling new frontiers, Aarthvaahini is your trusted partner
// //             in wealth creation, capital raising, and risk mitigation.
// //           </p>
// //         </div>
...
// //                 creation, wealth management, loans and capital lets us build
// //                 holistic solutions that single-avenue firms cannot replicate.
// //               </p>
// //             </Card>
...
// //               <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
// //                 We don&apos;t believe in one-size-fits-all. Through our network
// //                 and corporate partnerships, we hold codes with 50+ leading
// //                 financial institutions — so we&apos;re never restricted to a
// //                 single suite of products.
// //               </p>
// //             </Card>
...
// //               <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
// //                 Trust is earned through competence and compliance. Our team
// //                 holds premier industry credentials:
// //               </p>
...
// //                 <em>complete transparency</em>. From fee structures and product
// //                 risks to the underlying mechanics of your customized solution,
// //                 you are fully informed at every single step of your financial
// //                 roadmap.
// //               </p>
// //             </Card>
// //           </div>
...
// //                     Asset & Capital Financing:
// //                   </strong>{" "}
// //                   Loans Against Property and customized Working Capital
// //                   solutions to optimize cash flow.
// //                 </li>

// //                 <li>
// //                   <strong className="text-foreground">Project Finance:</strong>{" "}
// //                   End-to-end fundraising and structuring for Greenfield and
// //                   Brownfield projects.
// //                 </li>

// //                 <li>
// //                   <strong className="text-foreground">Private Equity:</strong>{" "}
...
// //                 <li>
// //                   <strong className="text-foreground">
// //                     Life Goal Milestones:
// //                   </strong>{" "}
// //                   Step-by-step corpus creation for buying your dream house,
// //                   funding children&apos;s higher education, marriage expenses,
// //                   or career pivots.
// //                 </li>
...
// //               Aarthvaahini
// //             </strong>
// //             &quot; means a continuous flow of wealth and purpose. We don&apos;t
// //             just sell financial products; we engineer tailor-made solutions
// //             capable of tackling the most complex demands.
// //           </p>
// //         </Card>
...
// //               <a
// //                 href={registeredOffice.mapLink}
// //                 target="_blank"
// //                 rel="noreferrer"
// //                 className="mt-4 inline-flex items-center gap-2 rounded-xl bg-sky-100 px-5 py-3 text-sm font-semibold text-sky-700 shadow-sm transition hover:-translate-y-0.5 hover:bg-sky-200 hover:shadow-md"
// //               >
// //                 View on Google Maps
...
// //             <p className="mt-2 text-muted-foreground">
// //               Visit our Ahmedabad marketing office or open Google Maps for
// //               directions.
// //             </p>
// //           </div>
...
// //                     {marketingOffice.city}
// //                   </h3>

// //                   <p className="mt-3 text-sm leading-7 text-muted-foreground">
// //                     {marketingOffice.address}
// //                   </p>

// //                   <a
// //                     href={marketingOffice.mapLink}
// //                     target="_blank"
// //                     rel="noreferrer"
// //                     className="mt-5 inline-flex items-center gap-2 rounded-xl bg-sky-100 px-5 py-3 text-sm font-semibold text-sky-700 shadow-sm transition hover:-translate-y-0.5 hover:bg-sky-200 hover:shadow-md"
// //                   >
// //                     View on Google Maps
// //                     <ExternalLink className="h-4 w-4" />
// //                   </a>
...
// //           {[
// //             { icon: Users, n: "1,678+", l: "Happy Customers" },
...
//                   <a
//                     href={`tel:${marketingOffice.phone.replace(/\s/g, "")}`}
//                     className="mt-3 flex items-center gap-2 text-sm font-semibold text-muted-foreground transition hover:text-primary"
//                   >
//                     <Phone className="h-4 w-4 text-primary" />
      ...
      <main className="container mx-auto px-6 py-24">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          {[
            { icon: Users, n: "1,678+", l: "Happy Customers" },
            { icon: Building2, n: "50+", l: "Institutional Partners" },
            { icon: Award, n: "₹890 Cr+", l: "Disbursed" },
          ].map(({ icon: Icon, n, l }) => (
            <Card key={l} className="p-6 text-center shadow-soft">
              <Icon className="mx-auto h-7 w-7 text-primary" />
