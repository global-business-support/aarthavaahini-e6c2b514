...
//                       src={director.image}
//                       alt={director.name}
//                       className="h-[300px] w-full object-contain object-bottom transition duration-500 group-hover:scale-105 sm:h-[380px]"
//                     />
//                   </div>
//                 </div>
//               ))}
...
//               <div className="relative min-h-[420px] bg-[#f7f1f1]">
...
//                   className="relative z-10 h-full max-h-[620px] w-full object-contain object-bottom p-6"
//                 />
//               </div>
