...
// //                 <AccordionTrigger>Can I apply online?</AccordionTrigger>
// //                 <AccordionContent>
// //                   Yes, you can apply online for loans, insurance and
// //                   investments.
// //                 </AccordionContent>
// //               </AccordionItem>
// //             </Accordion>
...
// export function Footer() {
//   const [openSection, setOpenSection] = useState<MobileFooterSection | null>(
//     null,
//   );
...
//       {/* FOOTER CONTENT */}
//       <div className="border-t border-border/40 bg-white">
//         <div className="container mx-auto px-6 py-10 lg:grid lg:grid-cols-[1.4fr_0.8fr_0.9fr_0.9fr_1.4fr_0.8fr] lg:gap-8 lg:py-14">
//           {/* COMPANY INFO */}
//           <div className="flex flex-col">
//             <Link to="/" className="inline-flex items-center">
//               <img
...
//                 <div className="flex flex-col gap-3 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground">
//                   <Link to="/loans" className="transition hover:text-primary">
//                     Loan
//                   </Link>
...
//               {openSection === "contact" && (
//                 <div className="flex flex-col gap-4 border-t border-slate-100 px-4 py-4 text-sm text-muted-foreground">
//                   <a
//                     href="tel:+919827679993"
//                     className="flex items-center gap-3 transition hover:text-primary"
//                   >
...
//                       2nd Floor, Shrinath Tower, Opposite C3 Hospital, Behind
//                       C21 Mall, Vijay Nagar, Indore, MP 452010
//                     </span>
//                   </div>
//                 </div>
//               )}
...
export function Footer() {
  ...
  return (
    <footer id="contact" className="bg-white">
      ...
      {/* FOOTER CONTENT */}
      <div className="border-t border-border/40 bg-white pb-24 lg:pb-0">
        <div className="container mx-auto px-6 py-10 lg:grid lg:grid-cols-[1.4fr_0.8fr_0.9fr_0.9fr_1.4fr_0.8fr] lg:gap-8 lg:py-14">
          {/* COMPANY INFO */}
          <div className="flex flex-col">
            <Link to="/" className="inline-flex items-center">
      ...
      {/* COPYRIGHT */}
      <div className="border-t border-border/60 bg-white pb-28 pt-5 lg:pb-5">
        <div className="container mx-auto flex flex-col items-center justify-between gap-3 px-6 text-center text-xs text-muted-foreground sm:flex-row sm:text-left">
          <p>
            © {new Date().getFullYear()} Aarthvaahini Financial Services Pvt.
            Ltd. All rights reserved.
