      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <div className="rounded-3xl border bg-white p-6 shadow-sm lg:col-span-3">
            ...
            >
              <TabsList className="grid h-auto grid-cols-4 gap-1 bg-slate-100 p-1 lg:grid-cols-4">
                {PRODUCTS.slice(0, 4).map((p) => (
                  <TabsTrigger
                    key={p.key}
                    value={p.key}
                    className={`py-2 text-xs ${ACTIVE_TAB_CLASS[p.key]}`}
                  >
              ...
              <TabsList className="mt-2 grid h-auto grid-cols-4 gap-1 bg-slate-100 p-1">
                {PRODUCTS.slice(4).map((p) => (
                  <TabsTrigger
                    key={p.key}
                    value={p.key}
