...
import adminDashboardLaptopImg from "@/assets/admin-dashboard-laptop.png";
    ...
    <section className="bg-secondary/40 py-24">
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-display text-4xl font-bold sm:text-5xl">
            Admin Panel &{" "}
            <span className="text-gradient">Lead Management</span>
          </h2>

          <p className="mt-4 text-muted-foreground">
            A powerful command-centre for your team — track leads, run CIBIL
            checks, manage applications and grow your book of business.
            Available on web.
          </p>
        </div>

        <div className="mt-14 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
          {/* LEFT CRM DASHBOARD CARD */}
          <Card className="overflow-hidden border/60 bg-card p-0 shadow-elegant">
            <div className="flex items-center justify-between border-b border-border/60 bg-gradient-primary px-6 py-4 text-primary-foreground">
              <div>
              ...
              <Badge className="bg-card/20 text-primary-foreground hover:bg-card/20">
                Live
              </Badge>
            </div>
            ...
            <div className="px-6 pb-6">
              ...
              <div className="overflow-hidden rounded-xl border/60">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {leads.map((lead) => (
                      <tr key={lead.name} className="border-t border/60">
          ...
          <Card className="relative overflow-hidden rounded-[28px] border/60 bg-card p-0 shadow-elegant">
            <img
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white via-white/90 to-transparent p-6">
              <h3 className="font-display text-2xl font-bold text-foreground">
                Web Based Admin Dashboard
              </h3>

              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Track leads, manage applications, monitor disbursements,
                review business performance and generate reports in real-time.
              </p>
            </div>
          </Card>
        </div>
